...
> 根据我的检查，以下是 Jetchat 项目的主要界面组件：
>
> ### 主要 Activity
>
> - **NavActivity** - 路径：`app/src/main/java/com/example/compose/jetchat/NavActivity.kt`
>   - 应用的主入口点
>
> ### 主要 Fragment
>
> - **ConversationFragment** - 路径：`app/src/main/java/com/example/compose/jetchat/> conversation/ConversationFragment.kt`
>   - 聊天对话界面的容器
> - **ProfileFragment** - 路径：`app/src/main/java/com/example/compose/jetchat/profile/> ProfileFragment.kt`
>   - 用户资料界面的容器
>
> ### 主要 Composable 界面
>
> - **ConversationContent** - 路径：`app/src/main/java/com/example/compose/jetchat/> conversation/Conversation.kt`
>   - 聊天对话的主要 Compose 界面
> - **UserInput** - 路径：`app/src/main/java/com/example/compose/jetchat/conversation/> UserInput.kt`
>   - 消息输入区域的 Compose 界面
> - **ProfileScreen** - 路径：`app/src/main/java/com/example/compose/jetchat/profile/> Profile.kt`
>   - 用户资料的主要 Compose 界面
> - **JetchatDrawer** - 路径：`app/src/main/java/com/example/compose/jetchat/components/> JetchatDrawer.kt`
>   - 导航抽屉的 Compose 界面
>
> ### 小部件相关
>
> - **JetChatWidget** - 路径：`app/src/main/java/com/example/compose/jetchat/widget/> JetChatWidget.kt`
>   - 应用的主屏幕小部件实现
>
